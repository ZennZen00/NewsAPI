...
parameters = {
    ...
    'category': 'Health', #Kategori berita
    'language': 'id', #bahasa berita
    'sortBy': 'relevancy', # Mengurutkan berdasarkan popularitas
    'pageSize': 20, # Jumlah artikel yang muncul
    'from': '2023-12-11',  # Ambil artikel mulai dari tanggal tertentu
    'to': '2024-1-6',  # Ambil artikel hingga tanggal tertentu
    'apiKey': API_KEY
